            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-6">
                    <div class="single_course text-center">
                        ...
                        <p>
                        Vous trouverez ici tous les cours <br> de la licence 2 <br>
                            classés par matière.
                        </p>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-lg-6">
                    <div class="single_course text-center">
                        ...
                        <p>
                        Vous trouverez ici tous les sujets TD<br> de la licence 2 <br>
                            classés par matière.
                        </p>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-lg-6">
                    <div class="single_course text-center">
                        ...
                        <p>
                        Vous trouverez ici tous les sujets TP<br> de la licence 2 <br>
                            classés par matière.
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-6">
                    <div class="single_course text-center">
                        ...
                        <p>
                        Vous trouverez ici tous les sujets DS<br> de la licence 2 <br>
                            classés par matière.
                        </p>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-lg-6">
                    <div class="single_course text-center">
                        ...
                        <p>
                        Vous trouverez ici tous les sujets d'examens de la licence 2 <br>
                        classés par matière.
                        </p>
                    </div>
                </div>
